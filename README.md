...
- 💳 **Wallet integration**: [`ecobytes-wallet-integration`](https://github.com/BioZrod/ecobytes-wallet-integration/tree/sdk_dev) is an Android library that connects to Valora/Celo wallets through intents, so users can redeem EcoBytes points for Celo tokens
...
**Leading contributor** to this open-source network-telemetry project, with [74 commits, the most of any contributor](https://github.com/magma/openschema/graphs/contributors?from=8%2F9%2F2020&to=4%2F7%2F2022). I built the iOS module and reworked the Android data-usage collection and storage layer.
